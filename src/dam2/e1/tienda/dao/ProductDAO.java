...
public class ProductDAO {
  ...
  private void initDAO() {
    ...
    if (isEmpty) {
      createNewProduct(new Product(getNewId(), "producto1", "la desc 1", 1.11, 11));
      createNewProduct(new Product(getNewId(), "producto2", "la desc 2", 2.22, 22));
      createNewProduct(new Product(getNewId(), "producto3", "la desc 3", 3.33, 33));
    }
  }
